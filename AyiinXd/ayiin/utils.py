...
async def autopilot():
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://telegra.ph//file/1a2576d41249b903e9833.jpg", "photoyins.jpg"
        )
...
async def autobot():
    try:
        ...
        if who.username:
            ...
            username = f"Daren{(str(who.id))[5:]}bot"
        bf = "@BotFather"
        ...
        if isdone.startswith("Sorry,"):
            ...
            if nowdone.startswith("Done!"):
                ...
                try:
                    ...
                    pass
                try:
                    await Ayiin(EditAdminRequest(var.BOTLOG_CHATID, username, new_rights, "Asisstant Daren"))
                    await asyncio.sleep(3)
                except BaseException:
                    pass
                await Ayiin.send_message(
